...
STab:AddToggle({
	Name = "White Screen [Not Upd Yet]",
	Default = false,
	Callback = function(Value)
      print("not upd yet")
      OrionLib:MakeNotification({
	Name = "A notification for u",
	Content = "wait for me upd it",
...
STab:AddButton({
	Name = "Fps Boost [Not Upd Yet]",
	Callback = function()
     print("WAIT ME UPD IT") 	
      OrionLib:MakeNotification({
	Name = "A notification for u",
	Content = "wait for me upd it",
	Image = "rbxassetid://4483345998",
...
--Weapon Tab
if World3 then
local Section = WeTab:AddSection({
	Name = "Item|Quest"
})

local Total_Elite_Hunter = WeTab:AddLabel("Elite Hunter")

local Elite_Hunter_Status = WeTab:AddLabel("Status")
...
WeTab:AddToggle({
                  ...
                  if game:GetService("Workspace").Enemies:FindFirstChild("Diablo [Lv. 1750]") or game:GetService("Workspace").Enemies:FindFirstChild("Deandre [Lv. 1750]") or game:GetService("Workspace").Enemies:FindFirstChild("Urban [Lv. 1750]") then
					...
					AutoHaki()
								...
								elseif game:GetService("ReplicatedStorage"):FindFirstChild("Urban [Lv. 1750]") then
									topos(game:GetService("ReplicatedStorage"):FindFirstChild("Urban [Lv. 1750]").HumanoidRootPart.CFrame * MethodFarm)end
							end                    
						end
					else
  ...
  local Section = Weapon:AddSection({
	Name = "Dough Boss"
})

  local Mob_Kill_Cake_Prince = WeTab:AddLabel("Total")
